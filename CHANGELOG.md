...
- O campo de tolerancia direcional do `Bollinger Filter` passou a se chamar `Incl. min. (pts/candle)` e ganhou rodape explicando o efeito do valor zero e de limites maiores.
