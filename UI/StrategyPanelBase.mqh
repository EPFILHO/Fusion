...
public:
   ...
   virtual bool   Create(CAppDialog *parent,const long chartId,const int subwin,const int x1,const int y1,const int x2,const int y2) = 0;
   virtual void   Show(void) = 0;
   virtual void   Hide(void) = 0;
   virtual void   Sync(const SUIPanelSnapshot &snapshot) = 0;
