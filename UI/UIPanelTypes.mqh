...
#define FUSION_STRATEGY_PANEL_COUNT 3
#define FUSION_FILTER_PANEL_COUNT   3
#define FUSION_PROTECT_OVERVIEW_COUNT 6
...
enum ENUM_FUSION_RISK_PAGE
  {
   FUSION_RISK_LOT = 0,
   FUSION_RISK_SLTP,
   FUSION_RISK_PARTIAL,
   FUSION_RISK_BREAKEVEN,
   FUSION_RISK_TRAILING,
   FUSION_RISK_COUNT
  };
